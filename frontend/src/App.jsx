...
// Removido: const API_URL = import.meta.env.VITE_API_URL || "http://localhost:5000"
// Usaremos o caminho relativo diretamente, pois o Ingress fará o roteamento.
...
function App() {
  ...
  const carregarMensagens = () => {
    // Alterado para usar caminho relativo
    fetch(`/api/mensagens`)
      .then(res => res.json())
      .then(setMensagens)
  }
